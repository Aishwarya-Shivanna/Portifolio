...
export function generatePersonSchema(): Record<string, unknown> {
  return {
    ...
    "@type": "Person",
    name: "Aishwarya Shivanna",
    url: "https://bjornmelin.com",
    jobTitle: "Business Analytics Master's Student",
    description:
...
export function generateWebsiteSchema(): Record<string, unknown> {
  return {
    "@context": "https://schema.org",
    "@type": "WebSite",
    name: "Aishwarya Shivanna - Portfolio",
    url: "https://bjornmelin.com",
    description:
      "Personal portfolio of Aishwarya Shivanna, Senior Data Scientist and AWS Machine Learning Engineer specializing in neuro-symbolic AI, deep learning, and cloud architecture.",
    author: {
      "@type": "Person",
      name: "Aishwarya Shivanna",
    },
